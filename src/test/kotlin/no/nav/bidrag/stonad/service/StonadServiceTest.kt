...
class StonadServiceTest {
    ...
    fun `skal finne alle gyldige perioder for en stønad`() {
        ...
        val opprettetStonad = stonadService.hentStonad(
            HentStonadRequest(
                ...
                opprettStonadRequest.sakId,
                opprettStonadRequest.skyldnerId,
                opprettStonadRequest.kravhaverId
            )
        )
    ...
    fun `skal finne alle perioder for en stønad, også ugyldiggjorte - Ugyldiggjorte kommer etter gyldige perioder`() {
        ...
        val opprettStonadRequest = OpprettStonadRequestDto(
            StonadType.BIDRAG, "SAK-001", "Skyldner123", "Kravhaver123",
            "MottakerId123", "2024", Innkreving.JA, "R153961", periodeListe
        )

        stonadService.opprettStonad(opprettStonadRequest)

        val funnetStonad = stonadService.hentStonadInkludertUgyldiggjortePerioder(
            opprettStonadRequest.type.toString(),
            opprettStonadRequest.skyldnerId,
            opprettStonadRequest.kravhaverId,
            opprettStonadRequest.sakId
        )
    ...
    fun `skal endre eksisterende stønad`() {
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-01-01"), periodeTil = LocalDate.parse("2021-03-01"), vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.01), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-03-01"), periodeTil = LocalDate.parse("2021-07-01"), vedtakId = 1,
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-07-01"), periodeTil = LocalDate.parse("2021-12-01"), vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.03), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )

        val originalStonadRequest = OpprettStonadRequestDto(
            StonadType.BIDRAG, "SAK-001", "Skyldner123", "Kravhaver123",
            "MottakerId123", "2024", Innkreving.JA, "R153961", periodeListe
        )
        ...
        val originalStonad = stonadService.hentStonadInkludertUgyldiggjortePerioder(
            ...
            originalStonadRequest.skyldnerId,
            originalStonadRequest.kravhaverId,
            originalStonadRequest.sakId
        )
        ...
        endretStonadPeriodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-05-01"), periodeTil = LocalDate.parse("2021-06-01"), vedtakId = 2,
        ...
        endretStonadPeriodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-06-01"), periodeTil = LocalDate.parse("2021-08-01"), vedtakId = 2,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(5000.02), valutakode = "NOK",
                resultatkode = "Ny periode lagt til"
            )
        )
        endretStonadPeriodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-08-01"), periodeTil = LocalDate.parse("2021-10-01"), vedtakId = 2,
        ...
        val endretStonadRequest = OpprettStonadRequestDto(
            StonadType.BIDRAG, "SAK-001", "Skyldner123", "Kravhaver123",
        ...
        val endretStonad = stonadService.hentStonadInkludertUgyldiggjortePerioder(
            endretStonadRequest.type.toString(),
            endretStonadRequest.skyldnerId,
            endretStonadRequest.kravhaverId,
            endretStonadRequest.sakId
        )
    ...
    fun `Test på splitt av perioder med vedtak med periode midt i eksisterende stønad`() {
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-01-01"), periodeTil = LocalDate.parse("2022-01-01"), vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.01), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
    ...
    fun `Test med null i tildato på ny vedtaksperiode`() {
        ...
        endretStonadPeriodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-05-01"), periodeTil = null, vedtakId = 2,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(5000.01), valutakode = "NOK",
                resultatkode = "Ny periode lagt til"
            )
        )
    ...
    fun `Test med null i tildato på eksisterende stønadsperiode`() {
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-01-01"), periodeTil = null, vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.01), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
    ...
    fun `Test med like perioder og endret beløp i én periode`() {
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-01-01"), periodeTil = LocalDate.parse("2021-05-01"), vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.01), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-05-01"), periodeTil = LocalDate.parse("2021-06-01"), vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.02), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-06-01"), periodeTil = null, vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.03), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
        ...
        endretStonadPeriodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-01-01"), periodeTil = LocalDate.parse("2021-05-01"), vedtakId = 2,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.01), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
        ...
        endretStonadPeriodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-06-01"), periodeTil = null, vedtakId = 2,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.03), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
    ...
    fun `skal finne historiske perioder for en stønad`() {
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-01-01"), periodeTil = LocalDate.parse("2022-01-01"), vedtakId = 2,
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-01-01"), periodeTil = LocalDate.parse("2021-04-01"), vedtakId = 1,
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-04-01"), periodeTil = LocalDate.parse("2021-06-01"), vedtakId = 1,
        ...
        periodeListe.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.parse("2021-06-01"), periodeTil = LocalDate.parse("2022-01-01"), vedtakId = 1,
        ...
        val funnetStonad = stonadService.hentStonadHistorisk(
            HentStonadHistoriskRequest(
                opprettStonadRequest.type,
                opprettStonadRequest.sakId,
                opprettStonadRequest.skyldnerId,
                opprettStonadRequest.kravhaverId,
    ...
    fun `skal finne alle stønader for angitt sakId`() {
        ...
        periodeListe1.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.now(), periodeTil = LocalDate.now().plusDays(30), vedtakId = 1,
                gyldigFra = LocalDateTime.now(), gyldigTil = null, periodeGjortUgyldigAvVedtakId = null, belop = BigDecimal.valueOf(17.01), valutakode = "NOK",
                resultatkode = "Alles gut"
            )
        )
        ...
        val opprettStonadRequest1 = OpprettStonadRequestDto(
            StonadType.BIDRAG, "SAK-001", "Skyldner001", "Kravhaver001",
        ...
        periodeListe2.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.now(), periodeTil = LocalDate.now().plusDays(30), vedtakId = 2,
        ...
        val opprettStonadRequest2 = OpprettStonadRequestDto(
            StonadType.BIDRAG, "SAK-002", "Skyldner002", "Kravhaver002",
        ...
        periodeListe3.add(
            OpprettStonadPeriodeRequestDto(
                periodeFom = LocalDate.now(), periodeTil = LocalDate.now().plusDays(30), vedtakId = 3,
        ...
        val opprettStonadRequest3 = OpprettStonadRequestDto(
            StonadType.FORSKUDD, "SAK-001", "Skyldner001", "Kravhaver001",
