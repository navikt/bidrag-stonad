...
internal class DefaultBehandleHendelseServiceTest {
    ...
    fun `skal opprette ny stønad fra Hendelse`() {
        ...
        val nyHendelse =
            VedtakHendelse(
                Vedtakskilde.MANUELT, Vedtakstype.ALDERSJUSTERING, 1, "X123456", "Navn", "Bisys",
                LocalDateTime.now(), Enhetsnummer("enhetsnummer1"), null, null, LocalDateTime.now(), stønadsendringListe,
                emptyList(), emptyList(), Sporingsdata(""),
            )

        behandleHendelseService.behandleHendelse(nyHendelse)

        val nyStonadOpprettet =
        ...
        assertAll(
            ...
            Executable { Assertions.assertThat(nyStonadOpprettet!!.opprettetAv).isEqualTo("X123456") },
    ...
    fun `skal ikke opprette ny stønad fra Hendelse med ingen perioder`() {
        ...
        val nyHendelse =
            VedtakHendelse(
                Vedtakskilde.MANUELT, Vedtakstype.ALDERSJUSTERING, 1, "R153961", null, "Bisys",
                LocalDateTime.now(), Enhetsnummer("enhetsnummer1"), null, null,
    ...
    fun `skal ikke opprette ny stønad fra Hendelse når beslutning er Stadfestelse eller Innkrevingstype = nei`() {
        ...
        stønadsendringListe.add(
            Stønadsendring(
                ...
                Personident("Skyldner1"), Personident("Kravhaver1"), Personident("Mottaker1"), 2024,
        ...
        val nyHendelse =
            VedtakHendelse(
                Vedtakskilde.MANUELT, Vedtakstype.ALDERSJUSTERING, 1, "R153961", null, "Bisys", LocalDateTime.now(),
                Enhetsnummer("enhetsnummer1"), null, null,
                LocalDateTime.now(), stønadsendringListe, emptyList(), emptyList(), Sporingsdata(""),
            )
    ...
    fun `skal oppdatere eksisterende stønad med like fra- og til-datoer og ulike beløp, tester også på gyldigFra og gyldigTil`() {
        ...
        originalStønadsendringListe.add(
            Stønadsendring(
                Stønadstype.BIDRAG, Saksnummer("Sak1"), Personident("Skyldner1"), Personident("Kravhaver1"),
                Personident("Mottaker1"), 2024,
        ...
        val originalHendelse =
            VedtakHendelse(
                kilde = Vedtakskilde.MANUELT, type = Vedtakstype.ALDERSJUSTERING, id = 1, opprettetAv = "R153961",
                opprettetAvNavn = "Sigge Saksbehandler", kildeapplikasjon = "Bisys",
                vedtakstidspunkt = LocalDateTime.parse("2020-10-17T10:12:14.169121000"),
                enhetsnummer = Enhetsnummer("enhetsnummer1"),
                innkrevingUtsattTilDato = null, fastsattILand = null, opprettetTidspunkt = LocalDateTime.now(),
                stønadsendringListe = originalStønadsendringListe, engangsbeløpListe = emptyList(), behandlingsreferanseListe = emptyList(),
        ...
        val hendelse =
            VedtakHendelse(
                kilde = Vedtakskilde.MANUELT, type = Vedtakstype.ALDERSJUSTERING, id = 2, opprettetAv = "R153961",
                opprettetAvNavn = "Sigge Saksbehandler", kildeapplikasjon = "Bisys",
        ...
        assertAll(
            ...
            Executable {
                Assertions.assertThat(
                    oppdatertStonad.periodeListe[0].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    oppdatertStonad.periodeListe[1].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    oppdatertStonad.periodeListe[2].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785"))
            },
            Executable { Assertions.assertThat(allePerioderInkludertUgyldiggjorte.size).isEqualTo(6) },
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[3].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-17T10:12:14.169121000"))
            },
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[3].gyldigTil,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785000"))
            },
    ...
    fun `test på at gyldigFra og gyldigTil blir satt riktig ved splitt av perioder`() {
        ...
        val originalHendelse =
            VedtakHendelse(
                ...
                innkrevingUtsattTilDato = null, fastsattILand = null, opprettetTidspunkt = LocalDateTime.now(),
                stønadsendringListe = originalStønadsendringListe, engangsbeløpListe = emptyList(), emptyList(),
                sporingsdata =
                Sporingsdata(
                    "",
                ),
        ...
        val førsteEndringHendelse =
            VedtakHendelse(
                ...
                vedtakstidspunkt = LocalDateTime.parse("2020-10-20T20:12:14.246785000"), enhetsnummer = Enhetsnummer("enhetsnummer1"),
                innkrevingUtsattTilDato = null, fastsattILand = null, opprettetTidspunkt = LocalDateTime.now(),
                stønadsendringListe = foersteEndringStønadsendringListe, engangsbeløpListe = emptyList(), emptyList(),
                sporingsdata =
                Sporingsdata(
                    "",
                ),
        ...
        val andreEndringHendelse =
            VedtakHendelse(
                kilde = Vedtakskilde.MANUELT, type = Vedtakstype.ALDERSJUSTERING, id = 3, opprettetAv = "R153961",
                opprettetAvNavn = "Sigge Saksbehandler", kildeapplikasjon = "Bisys",
                vedtakstidspunkt = LocalDateTime.parse("2020-10-30T01:22:17.246755000"), enhetsnummer = Enhetsnummer("enhetsnummer1"),
                innkrevingUtsattTilDato = null, fastsattILand = null, opprettetTidspunkt = LocalDateTime.now(),
                stønadsendringListe = andreEndringStønadsendringListe, engangsbeløpListe = emptyList(), emptyList(),
                sporingsdata =
                Sporingsdata(
                    "",
                ),
        ...
        assertAll(
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[0].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[1].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[2].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-30T01:22:17.246755000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[4].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-30T01:22:17.246755000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[5].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-17T10:12:14.169121000"))
            },
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[5].gyldigTil,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[6].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-10-20T20:12:14.246785000"))
            },
            Executable {
                Assertions.assertThat(
                    allePerioderInkludertUgyldiggjorte[6].gyldigTil,
                ).isEqualTo(LocalDateTime.parse("2020-10-30T01:22:17.246755000"))
            },
        )
    }
    ...
    fun `test på periodisering ved opphør og eksisterende perioder frem i tid`() {
        ...
        opphoerPeriodeliste.add(
            Periode(
                periode = ÅrMånedsperiode(LocalDate.parse("2021-06-01"), null),
                beløp = null,
                valutakode = null,
        ...
        val opphørHendelse =
            VedtakHendelse(
                ...
                innkrevingUtsattTilDato = null, fastsattILand = null, opprettetTidspunkt = LocalDateTime.now(),
                stønadsendringListe = opphoerStønadsendringListe, engangsbeløpListe = emptyList(), emptyList(),
                sporingsdata =
                Sporingsdata(
                    "",
                ),
        ...
        val oppdatertStønadEtterOpphør =
            stønadService.hentStønad(
                HentStønadRequest(
        ...
        val allePerioderEtterOpphoer =
            persistenceService.hentPerioderForStønadInkludertUgyldiggjorte(
                oppdatertStønadEtterOpphør!!.stønadsid,
            )
        ...
        val gjenopptagelseHendelse =
            VedtakHendelse(
                ...
                innkrevingUtsattTilDato = null, fastsattILand = null, opprettetTidspunkt = LocalDateTime.now(),
                stønadsendringListe = gjenopptagelseStønadsendringListe, engangsbeløpListe = emptyList(), emptyList(),
                sporingsdata =
                Sporingsdata(
                    "",
                ),
        ...
        assertAll(
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderEtterGjenopptagelse[0].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2021-05-20T20:12:14.246785000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderEtterGjenopptagelse[1].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2022-01-30T01:22:17.246755000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderEtterGjenopptagelse[2].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-12-17T10:12:14.169121000"))
            },
            Executable {
                Assertions.assertThat(
                    allePerioderEtterGjenopptagelse[2].gyldigTil,
                ).isEqualTo(LocalDateTime.parse("2021-05-20T20:12:14.246785000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderEtterGjenopptagelse[3].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-12-17T10:12:14.169121000"))
            },
            Executable {
                Assertions.assertThat(
                    allePerioderEtterGjenopptagelse[3].gyldigTil,
                ).isEqualTo(LocalDateTime.parse("2021-05-20T20:12:14.246785000"))
            },
        )
    }
    ...
    fun `test på periodisering ved opphør`() {
        ...
        opphoerPeriodeliste.add(
            Periode(
                ÅrMånedsperiode(LocalDate.parse("2021-11-01"), null),
                beløp = null,
                valutakode = null,
                resultatkode = "Opphoer",
                delytelseId = null,
        ...
        val oppdatertStonadEtterOpphoer =
            stønadService.hentStønad(
                HentStønadRequest(
        ...
        val allePerioderEtterOpphoer =
            persistenceService.hentPerioderForStønadInkludertUgyldiggjorte(
                oppdatertStonadEtterOpphoer!!.stønadsid,
            )
        ...
        assertAll(
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderEtterOpphoer[0].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-12-17T10:12:14.169121000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderEtterOpphoer[1].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2021-05-20T20:12:14.246785000"))
            },
            ...
            Executable {
                Assertions.assertThat(
                    allePerioderEtterOpphoer[2].gyldigFra,
                ).isEqualTo(LocalDateTime.parse("2020-12-17T10:12:14.169121000"))
            },
            Executable {
                Assertions.assertThat(
                    allePerioderEtterOpphoer[2].gyldigTil,
                ).isEqualTo(LocalDateTime.parse("2021-05-20T20:12:14.246785000"))
            },
        )
    }
    ...
    fun `skal oppdatere mottaker på eksisterende stønad`() {
        ...
        val originalHendelse =
            VedtakHendelse(
                Vedtakskilde.MANUELT, Vedtakstype.ALDERSJUSTERING, 1,
                "R153961", "Sigge Saksbehandler", "Bisys",
                LocalDateTime.now(), Enhetsnummer("enhetsnummer1"), null,
                fastsattILand = null, LocalDateTime.now(), originalStønadsendringListe, emptyList(), emptyList(), Sporingsdata(""),
            )
        ...
        val hendelse =
            VedtakHendelse(
                Vedtakskilde.MANUELT, Vedtakstype.ENDRING_MOTTAKER, 1,
                "R153961", "Sigge Saksbehandler", "Bisys",
                LocalDateTime.now(), Enhetsnummer("enhetsnummer1"), null,
                fastsattILand = null, LocalDateTime.now(), stønadsendringListe, emptyList(), emptyList(), Sporingsdata(""),
            )
